...
Source: [dae upstream](https://github.com/daeuniverse/dae/blob/1ec85feddc721088ecdda73015bd78f652926b39/docs/en/user-guide/kernel-parameters.md) · [AGPL-3.0 license](/upstream/dae-LICENSE.txt).
