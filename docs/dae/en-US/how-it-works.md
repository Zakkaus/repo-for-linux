...
(`auto_sniff_punt`, see [routing](/dae/configuration/routing)) so the whitelist keeps
...
Source: [dae upstream](https://github.com/daeuniverse/dae/blob/1ec85feddc721088ecdda73015bd78f652926b39/docs/en/how-it-works.md) · [AGPL-3.0 license](/upstream/dae-LICENSE.txt).
